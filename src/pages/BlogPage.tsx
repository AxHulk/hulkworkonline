  ...
  return (
    <Layout>
      <SEO
        ...
        description="Экспертные статьи о создании сайтов, SEO-продвижении, SMM, поведенческих факторах и платной рекламе. 50+ материалов от практикующих специалистов."
        jsonLd={buildBreadcrumbJsonLd([{ name: "Блог", url: "/blog" }])}
      />
      <BlogHeroSection />
