  ...
  return (
    <Layout>
      ...
      <FaqSection
        ...
        items={[
          { q: "Сколько стоит сделать сайт для компании?", a: "Стартовая цена лендинга — от $500, корпоративного сайта под ключ — от $700, интернет-магазина — от $800, корпоративного портала — от $1500. Точную стоимость рассчитываем за 24 часа после короткого брифа." },
