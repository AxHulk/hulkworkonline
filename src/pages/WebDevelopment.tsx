  ...
  return (
    <Layout>
      ...
      <FaqSection
        ...
        items={[
          { q: "Сколько стоит сделать сайт для компании?", a: "Стартовая цена лендинга — от $500, корпоративного сайта под ключ — от $1200, интернет-магазина — от $2000, корпоративного портала — от $3500. Точную стоимость рассчитываем за 24 часа после короткого брифа." },
