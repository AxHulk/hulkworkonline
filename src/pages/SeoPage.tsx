...
const SeoPage = () => {
  ...
  return (
    <Layout>
      ...
      />
      <FaqSection
        title="Частые вопросы про комплексное SEO"
        items={[
          ...
          { q: "Сколько стоит комплексное SEO?", a: `Стартовый аудит и настройка — от ${formatRub(500, rate)}. Ежемесячное сопровождение — от ${formatRub(400, rate)}. Точная вилка зависит от региона, ниши и текущего состояния сайта.` },
          { q: "Можно ли заказать только аудит без месячного абонемента?", a: `Да. Разовый SEO-аудит сайта стоит от ${formatRub(300, rate)} и включает отчёт на 30+ страниц с приоритизированным списком работ.` },
        ]}
      />
    </Layout>
  );
