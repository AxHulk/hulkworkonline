    ...
    <Layout>
      ...
      <FaqSection
        ...
        items={[
          ...
          { q: "Сколько стоит комплексное SEO?", a: "Стартовый аудит и настройка — от $500. Ежемесячное сопровождение — от $400. Точная вилка зависит от региона, ниши и текущего состояния сайта." },
          { q: "Можно ли заказать только аудит без месячного абонемента?", a: "Да. Разовый SEO-аудит сайта стоит от $300 и включает отчёт на 30+ страниц с приоритизированным списком работ." },
        ]}
      />
    </Layout>
  );
